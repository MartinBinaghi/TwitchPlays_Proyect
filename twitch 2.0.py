...
PASS = "oauth:z63t49k4tlmh47udm5c2xrfpmtswtk"

#What you'd like to name your bot
BOT = "martin_bot"

#The channel you want to monitor
channel = "martin_binaghi"

#Your account
OWNER = "martin_binaghi"
...
def gamecontrol():
	...
	while True:
		...
		if "up" == message.lower():
			randomCommand = random.randint(0,20)
